from PyPoRoMOD.enum import PlayerGender, Unlockables, Achievements, SignatureSpecies, systemShortKeys, Unlockables
...
def convertSystemDataStr(dataStr: str, shorten: bool = False) -> str:
    ...
    fromKeys = list(systemShortKeys.keys()) if shorten else list(systemShortKeys.values())
